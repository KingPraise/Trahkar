...
export default function ProfileView({
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 pb-24">
      ...
      <div className="flex items-center gap-2 text-secondary dark:text-zinc-400 text-xs font-bold uppercase tracking-wider">
      ...
      <div className="bg-surface-container-lowest dark:bg-zinc-950 rounded-2xl border border-border dark:border-zinc-800 shadow-sm p-6 md:p-8 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full -mr-32 -mt-32"></div>
        <div className="relative flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
          
          <div className="relative group shrink-0">
            <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-surface dark:border-zinc-900 shadow-xl bg-surface-container-low">
              <img 
          ...
          <div className="space-y-2 grow">
            ...
            <p className="text-sm font-semibold text-secondary dark:text-zinc-400">
            ...
            <div className="flex flex-wrap gap-2 justify-center md:justify-start pt-1.5">
              ...
              <span className="px-3.5 py-1 bg-primary/10 text-primary dark:text-blue-300 rounded-full text-xs font-mono font-bold flex items-center gap-1.5 border border-primary/10">
                <Award className="w-3.5 h-3.5 text-primary dark:text-blue-300" />
      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-surface-container-lowest dark:bg-zinc-900 rounded-2xl border border-border dark:border-zinc-800 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-border dark:border-zinc-800/80 bg-surface-container-low/30 dark:bg-zinc-950 flex items-center gap-2">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs text-secondary dark:text-zinc-400 font-bold uppercase">Full Name</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full border border-border dark:border-zinc-700 bg-surface dark:bg-zinc-800 rounded-xl pl-10 pr-4 py-3 text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-bold"
                    required
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs text-secondary dark:text-zinc-400 font-bold uppercase">Email Address</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full border border-border dark:border-zinc-700 bg-surface dark:bg-zinc-800 rounded-xl pl-10 pr-4 py-3 text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
                    required
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs text-secondary dark:text-zinc-400 font-bold uppercase">Phone Number</label>
                <div className="relative">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs text-secondary dark:text-zinc-400 font-bold uppercase">Location / Territory</label>
                <div className="relative">
          ...
          <section className="bg-surface-container-lowest dark:bg-zinc-900 rounded-2xl border border-border dark:border-zinc-800 shadow-sm overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs text-secondary dark:text-zinc-400 font-bold uppercase">Pharmacy License Number</label>
                <input 
                  type="text" 
                  value={formSettings.pharmacyLicense || 'PCN/2023/4852'}
                  onChange={(e) => handleChange('pharmacyLicense', e.target.value)}
                  className="w-full border border-border dark:border-zinc-700 bg-surface dark:bg-zinc-800 rounded-xl px-4 py-3 text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-mono"
                  required
                />
              </div>

              <div className="flex flex-col gap-1.5">
                <label className="text-xs text-secondary dark:text-zinc-400 font-bold uppercase">Specialty Sector</label>
                <select 
                  value={formSettings.specialty || 'Community Pharmacy'} 
                  onChange={(e) => handleChange('specialty', e.target.value)}
                  className="w-full border border-border dark:border-zinc-700 bg-surface dark:bg-zinc-800 rounded-xl px-4 py-3 text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all cursor-pointer font-bold"
                >
        ...
        <div className="space-y-6">
            ...
            <div className="p-6 space-y-6">
              <div className="flex flex-col gap-3">
                ...
                <button 
                  ...
                  className="w-full border border-primary text-primary dark:text-blue-300 dark:border-blue-300 hover:bg-primary/5 transition-all py-2.5 rounded-xl text-xs font-black flex items-center justify-center gap-2 cursor-pointer shadow-xs"
                >
          ...
          <section className="bg-surface-container-lowest dark:bg-zinc-900 rounded-2xl border border-border dark:border-zinc-800 shadow-sm overflow-hidden">
            ...
            <div className="p-6 space-y-5">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs text-secondary dark:text-zinc-400 font-bold uppercase">Language</label>
                <select 
                  value={formSettings.language || 'English (Nigeria)'}
                  onChange={(e) => handleChange('language', e.target.value)}
                  className="w-full border border-border dark:border-zinc-700 bg-surface dark:bg-zinc-800 rounded-xl p-2.5 text-sm focus:ring-1 focus:ring-primary cursor-pointer font-semibold"
                >
      ...
      <div className="fixed bottom-0 left-0 md:left-64 right-0 bg-surface-container-lowest dark:bg-zinc-950 border-t border-border dark:border-zinc-800 p-4 flex justify-end items-center gap-3 z-40 shadow-lg animate-in slide-in-from-bottom duration-300">
        <button 
          type="button" 
          onClick={() => onNavigate('settings')}
          className="px-6 py-2.5 text-secondary dark:text-zinc-300 font-bold text-xs hover:bg-surface-container-high dark:hover:bg-zinc-800/60 rounded-xl transition-all cursor-pointer"
        >
          Cancel
        </button>
        <button 
      ...
      {passwordModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <form onSubmit={handlePasswordSubmit} className="bg-surface-container-lowest dark:bg-zinc-900 w-full max-w-sm rounded-[20px] p-6 shadow-2xl border border-border dark:border-zinc-800 space-y-4 animate-in zoom-in-95 duration-200">
            <h3 className="font-black text-base text-primary dark:text-blue-300 flex items-center gap-1.5">
              <Lock className="w-5 h-5 text-primary dark:text-blue-300" />
            ...
            <div className="space-y-3">
              <div className="flex flex-col gap-1">
                <label className="text-[10px] font-bold uppercase text-secondary dark:text-zinc-400">Current Password</label>
                <input 
                  type="password"
                  required
                  value={passwordForm.oldPassword}
                  onChange={(e) => setPasswordForm(prev => ({ ...prev, oldPassword: e.target.value }))}
                  className="w-full border border-border dark:border-zinc-700 bg-surface dark:bg-zinc-800 rounded-xl px-3 py-2.5 text-xs outline-none focus:ring-1 focus:ring-primary text-on-surface"
                />
              </div>
              
              <div className="flex flex-col gap-1">
                <label className="text-[10px] font-bold uppercase text-secondary dark:text-zinc-400">New Password</label>
                <input 
                  type="password"
                  required
              ...
              <div className="flex flex-col gap-1">
                <label className="text-[10px] font-bold uppercase text-secondary dark:text-zinc-400">Confirm New Password</label>
                <input 
                  type="password"
                  required
            ...
            <div className="flex justify-end gap-2.5 pt-2">
              <button 
                ...
                className="px-4 py-2 text-xs font-semibold text-secondary dark:text-zinc-400 rounded-xl hover:bg-surface-container-low dark:hover:bg-zinc-800"
              >
                Cancel
              </button>
              <button 
